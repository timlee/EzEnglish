...
public class SimpleDialog extends Dialog {
    protected static int default_width = WindowManager.LayoutParams.WRAP_CONTENT; // 寬度
    protected static int default_height = WindowManager.LayoutParams.WRAP_CONTENT;// 高度
